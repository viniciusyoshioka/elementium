...
import Animated, { AnimatedRef, runOnJS, scrollTo, SharedValue, useAnimatedGestureHandler, useAnimatedReaction, useAnimatedStyle, useSharedValue, withSpring, withTiming } from "react-native-reanimated"
...
export function Item(props: ItemProps) {
    ...
    const { children, positions, id, onDragEnd, scrollView, scrollY, editing } = props
